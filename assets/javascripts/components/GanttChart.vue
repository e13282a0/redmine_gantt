...
<div class="headline">
      <div class="left"></div>
      <div class="right">
        <div class="col" :class="[elm.majorSeparator ? 'fatBorderLeft' : elm.newYear ? 'borderLeft':'col', elm]" v-for="elm in timeBeam" :key="'year' + elm.startDate">
  ...
  <div class="headline">
      <div class="left"></div>
      <div class="right">
        <div class="col" :class="[elm.majorSeparator ? 'fatBorderLeft' : elm.newMonth ? 'borderLeft':'col', elm]" v-for="elm in timeBeam" :key="'month' + elm.startDate">
          <template v-if="elm.newMonth || elm.type === 'broken'">{{ elm.startDate.format("MMM") }}</template>
        </div>
      </div>
    </div>
      <!-- week -->
    <div class="headline">
      <div class="left"></div>
      <div class="right">
        <div class="col" :class="[elm.majorSeparator ? 'fatBorderLeft' : elm.newWeek ? 'borderLeft':'col', elm]"  v-for="elm in timeBeam" :key="'week' + elm.startDate">
    ...
    <div class="headline">
      <div class="left"></div>
      <div class="right">
        <div class="col" :class="[elm.majorSeparator ? 'fatBorderLeft' :'borderLeft']" v-for="elm in timeBeam" :key="'date' + elm.startDate">
    ...
    <div class="headline">
      <div class="left"></div>
      <div class="right">
        <div class="col" :class="[elm.majorSeparator ? 'fatBorderLeft' :'borderLeft']" v-for="elm in timeBeam" :key="'day' + elm.startDate">
